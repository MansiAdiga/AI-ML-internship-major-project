...
# Title
st.title("💳 Credit Card Fraud Detection using CTGAN")
...
- Synthetic fraud data generated using CTGAN
...
if st.button("Predict Transaction"):
    ...
    st.write(f"Legitimate Probability: {prediction_proba[0][0]:.4f}")
    st.write(f"Fraud Probability: {prediction_proba[0][1]:.4f}")
